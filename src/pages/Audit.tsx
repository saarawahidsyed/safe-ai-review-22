        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <main className="flex-1 p-6 space-y-4">
            <div>
              ...
              <h1 className="text-2xl font-semibold text-foreground mt-1">Reviewer Activity Log</h1>
                    ...
                    <li key={e.id} className="p-4 flex gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2 text-xs text-muted-foreground">
                          ...
                          <span className="font-mono text-foreground">{e.case_ref}</span>
                          <span>•</span>
                        ...
                        <p className="text-[10px] text-muted-foreground/70 mt-1 font-mono">user {e.user_id.slice(0, 8)}…</p>
                      </div>
                    </li>
                  ))}
                </ul>
